// To parse this data:
//
//   import { Convert, SachGifsResponse } from "./file";
//
//   const sachGifsResponse = Convert.toSachGifsResponse(json);
//
...
export class Convert {
    public static toSachGifsResponse(json: string): SearchGifsResponse {
        return cast(JSON.parse(json), r("SachGifsResponse"));
    }

    public static sachGifsResponseToJson(value: SearchGifsResponse): string {
        return JSON.stringify(uncast(value, r("SachGifsResponse")), null, 2);
    }
}
